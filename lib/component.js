...
class Component extends HTMLElement {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    if (newValue.startsWith('${')) return // Hack: avoid unparsed '${ … }'. TODO: find why it's called too early.
  ...
  render(state = {}) {
    ...
    const context = {}
    Object.keys(this.state).forEach(name => context[name] = HTMLParser.parseValue(this.state[name]))
